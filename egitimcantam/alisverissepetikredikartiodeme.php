	...
	if(isset($_SESSION["Kullanici"])){
		...
		if($SepettekiUrunSayisi > 0){
			...
			if($SepettekiToplamFiyat >= $UcretsizKargoBaraji){
				$SepettekiToplamKargoFiyatiHesapla = 0;
				$OdenecekToplamTutariHesapla = $SepettekiToplamFiyat;
				$SepettekiToplamKargoFiyatiBicimlendir = FiyatBicimlendir($SepettekiToplamKargoFiyatiHesapla);
			...
			$okUrl = "http://www.kitapkabimda.net/alisverissepetikredikartiodemesonuctamam.php";  //	Ödeme İşlemi Başarıyla Gerçekleşir ise Dönülecek Sayfa
			$failUrl = "http://www.kitapkabimda.net/alisverissepetikredikartiodemesonuchata.php";  //	Ödeme İşlemi Red Olur ise Dönülecek Sayfa
			$rnd = @microtime();
			...
			?>
			<form action="https://<sunucu_adresi>/<3dgate_path>"
			      method="post"> <!-- Bu Adres Banka veya EST Firması Tarafından Verilir -->
					...
					<tr>
						<td width="800" valign="top">
							<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
								...
								<tr height="30">
									<td valign="top"
									    style="border-bottom: 1px dashed #CCCCCC;">Kredi Kartı Bilgilerini Aşağıdan Belirtebilir ve Ödeme Yapabilirsin.
									</td>
								</tr>
								<tr height="10">
								...
								<tr>
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											...
											<tr height="40">
												<td>Kart Türü</td>
												<td colspan="4"><input type="radio" value="1" name="cardType"> Visa <input type="radio"
												                                                                           value="2"
											...
											<tr height="40">
												<td align="center">&nbsp;</td>
												<td colspan="4" align="left"><input type="submit" value="Ödeme Yap" class="TuruncuButon"/></td>
											</tr>
										</table>
									</td>
								</tr>
