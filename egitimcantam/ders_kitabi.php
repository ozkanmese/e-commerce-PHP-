<?php
	...
	$ToplamKayitSayisiSorgusu = $VeritabaniBaglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Ders Kitabı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC");
	$ToplamKayitSayisiSorgusu->execute();
	$ToplamKayitSayisiSorgusu = $ToplamKayitSayisiSorgusu->rowCount();
	$SayfalamayaBaslanacakKayitSayisi = ($Sayfalama * $SayfaBasinaGosterilecekKayitSayisi) - $SayfaBasinaGosterilecekKayitSayisi;
	$BulunanSayfaSayisi = ceil($ToplamKayitSayisiSorgusu / $SayfaBasinaGosterilecekKayitSayisi);
	
	$AnaMenununTumUrunSayiSorgusu = $VeritabaniBaglantisi->prepare("SELECT SUM(UrunSayisi) AS MenununToplamUrunu FROM menuler WHERE UrunTuru = 'Ders Kitabı'");
				...
				<tr>
					<td>
						<table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
							...
							<?php
								$MenulerSorgusu = $VeritabaniBaglantisi->prepare("SELECT * FROM menuler WHERE UrunTuru = 'Ders Kitabı' ORDER BY MenuAdi ASC");
								...
								foreach($MenuKayitlari as $Menu){
									?>
									<tr height="30">
										<td><a href="index.php?SK=1&MenuID=<?php echo $Menu["id"]; ?>"
			...
			<table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td>
						<table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr><?php
									$UrunlerSorgusu = $VeritabaniBaglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Ders Kitabı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
											...
											<table width="191" align="left" border="0" cellpadding="0" cellspacing="0"
												...
												<tr height="40">
													<td align="center"><a
															href="index.php?SK=89&ID=<?php echo DonusumleriGeriDondur($Kayit["id"]); ?>"><img
																src="Resimler/Urunler/DersKitabi/<?php echo DonusumleriGeriDondur($Kayit["UrunResmiBir"]); ?>"
												...
												<tr height="25">
													<td width="191" align="center"><a
															...
															style="color: #537ecf; font-weight: bold; text-decoration: none;">Ders Kitabı</a>
													</td>
												</tr>
												<tr height="25">
													<td width="191" align="center"><a
							...
							<td align="center">
								<div class="SayfalamaAlaniKapsayicisi">
									...
									<div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
										<?php
											if($Sayfalama > 1){
												echo "<span class='SayfalamaPasif'><a href='index.php?SK=1" . $SayfalamaKosulu . "&SYF=1'><<</a></span>";
												$SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama - 1;
												echo "<span class='SayfalamaPasif'><a href='index.php?SK=1" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
											}
											...
											for($SayfalamaIcinSayfaIndexDegeri = $Sayfalama - $SayfalamaIcinSolVeSagButonSayisi;$SayfalamaIcinSayfaIndexDegeri <= $Sayfalama + $SayfalamaIcinSolVeSagButonSayisi;$SayfalamaIcinSayfaIndexDegeri++){
												if(($SayfalamaIcinSayfaIndexDegeri > 0) and ($SayfalamaIcinSayfaIndexDegeri <= $BulunanSayfaSayisi)){
													if($Sayfalama == $SayfalamaIcinSayfaIndexDegeri){
														...
														echo "<span class='SayfalamaPasif'><a href='index.php?SK=1" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaIndexDegeri . "'> " . $SayfalamaIcinSayfaIndexDegeri . "</a></span>";
													}
												}
											}
											...
											if($Sayfalama != $BulunanSayfaSayisi){
												...
												echo "<span class='SayfalamaPasif'><a href='index.php?SK=1" . $SayfalamaKosulu . "&SYF=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
												echo "<span class='SayfalamaPasif'><a href='index.php?SK=1" . $SayfalamaKosulu . "&SYF=" . $BulunanSayfaSayisi . "'>>></a></span>";
											}
										?>
									</div>
								</div>
