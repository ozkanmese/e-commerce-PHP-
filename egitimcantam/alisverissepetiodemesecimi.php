<?php
	if(isset($_SESSION["Kullanici"])){
		...
		if(($GelenAdresSecimi != "") and ($GelenKargoSecimi != "")){
			...
			?>
			<form action="index.php?SK=113" method="post">
					...
					<tr>
						<td width="800" valign="top">
							<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
								...
								<tr height="30">
									<td valign="top"
									    style="border-bottom: 1px dashed #CCCCCC;">Ödeme Türü Seçimini Aşağıdan Belirtebilirsin.
									</td>
								</tr>
								<tr height="10">
											...
											<tr>
												<td width="390" align="left">
													<table width="400" align="center" border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td align="center"><input type="radio" name="OdemeTuruSecimi" value="Kredi Kartı"
															                          checked="checked" onClick="$.KrediKartiSecildi();"></td>
														</tr>
														<tr>
															<td>&nbsp;</td>
														</tr>
												...
												<td width="390" align="left">
													<table width="400" align="center" border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td align="center"><input type="radio" name="OdemeTuruSecimi" value="Banka Havalesi"
															                          onClick="$.BankaHavalesiSecildi();"></td>
														</tr>
														<tr>
															<td>&nbsp;</td>
														</tr>
								...
								<tr height="40" class="KKAlanlari">
									<td height="40" width="800"
									    align="left">Ödeme işleminizde aşağıdaki tüm kredi kartı markaları ile veya diğer markalar ile veya ATM(Bankamatik) kartı ile işlem yapabilirsiniz.
									</td>
								</tr>
								<tr height="10" class="KKAlanlari">
									<td style="font-size: 10px;">&nbsp;</td>
								...
								<tr class="KKAlanlari">
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td width="192">
													<table width="192" align="center" border="0" cellpadding="0" cellspacing="0"
													       style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
														<tr>
															<td>&nbsp;</td>
														</tr>
								...
								<tr height="40" class="KKAlanlari">
									<td height="40" width="800"
									    align="left">Lütfen ödeme işleminde uygulanmasını istediğiniz taksit sayısını seçiniz.
									</td>
								</tr>
								<tr height="30" class="KKAlanlari">
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												<td width="25" align="left" style="border-bottom: 1px dashed #CCCCCC;"><input type="radio"
												                                                                              name="TaksitSecimi"
												                                                                              value="1"
												                                                                              checked="checked">
												</td>
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">1 x <?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
											</tr>
										</table>
									</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">2 x <?php echo $IkiTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">3 x <?php echo $UcTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">4 x <?php echo $DortTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">5 x <?php echo $BesTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">6 x <?php echo $AltiTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">7 x <?php echo $YediTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">8 x <?php echo $SekizTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
									...
									<td>
										<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="30">
												...
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;">9 x <?php echo $DokuzTaksitAylikOdemeTutari; ?> TL
												</td>
												<td width="200" align="right"
												    style="border-bottom: 1px dashed #CCCCCC;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
												</td>
								...
								<tr height="40" class="BHAlanlari" style="display: none;">
									<td height="40" width="800" align="left" bgcolor="#CCCCCC"><b>&nbsp;Banka Havalesi / EFT İle Ödeme</b>
									</td>
								</tr>
						...
						<td width="250" valign="top">
							<table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<td align="right"
									    style="font-size: 25px; font-weight: bold;"><?php echo $OdenecekToplamTutariBicimlendir; ?> TL
									</td>
								</tr>
								<tr height="10">
									<td style="font-size: 10px;">&nbsp;</td>
								...
								<tr>
									<td align="right"
									    style="font-size: 25px; font-weight: bold;"><?php echo $SepettekiToplamKargoFiyatiBicimlendir; ?> TL
									</td>
								</tr>
								<tr height="10">
									<td style="font-size: 10px;">&nbsp;</td>
