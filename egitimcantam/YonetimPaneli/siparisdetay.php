...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	if($SiparislerSayisi>0){
		...
		foreach($SiparislerKayitlari as $SiparisBilgileri){
            ...
            if($SiparisBilgileri["UrunTuru"] == "Ders Kitabı"){
                $ResimKlasoru = "/Urunler/DersKitabi/";
            }elseif($SiparisBilgileri["UrunTuru"] == "Okuma Kitabı"){
                $ResimKlasoru = "/Urunler/OkumaKitaplari/";
            }elseif($SiparisBilgileri["UrunTuru"] == "Soru Bankası"){
                $ResimKlasoru = "/Urunler/SoruBankasi/";
            }elseif($SiparisBilgileri["UrunTuru"] == "Dergi"){
                $ResimKlasoru = "/Urunler/Dergiler";
            }elseif($SiparisBilgileri["UrunTuru"] == "Üniversite Kitabı"){
			...
			<tr>
				<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					...
					?>
					<tr>
						<td width="60" valign="top"><img src="../Resimler/<?php echo $ResimKlasoru; ?>/<?php echo DonusumleriGeriDondur($SiparisBilgileri["UrunResmiBir"]); ?>" border="0" width="60" height="80"></td>
						<td width="10">&nbsp;</td>
				...
				<tr height="40">
					<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100">&nbsp;</td>
							<td width="10">&nbsp;</td>
							<td width="540"><input type="submit" value="Gönderi Kodunu İşle ve Siparişi Tamamla" class="TuruncuButon"></td>
						</tr>
					</table></td>
				</tr>
			</table>
