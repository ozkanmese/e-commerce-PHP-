...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	if($UrunlerSayisi>0){
		foreach($UrunlerKayitlari as $Urunler){
            ...
            $UrununTuru = $UrunMenuKaydi["UrunTuru"];
	...
	<tr height="80">
		<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="60" valign="top"><img src="../Resimler/Urunler/<?php echo $UrunResimleriKlasoru; ?>/<?php echo DonusumleriGeriDondur($Urunler["UrunResmiBir"]); ?>" border="0" width="60" height="80"></td>
				<td width="10">&nbsp;</td>
