...
if(isset($_SESSION["Yonetici"])){
    ...
    <table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
        <tr height="100%">
            <td width="300" align="center" bgcolor="#9370db" valign="top"><table width="300" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr height="70">
            ...
            <td width="5" align="center" bgcolor="#8b008b" valign="top">&nbsp;</td>
