<?php
	if(isset($_SESSION["Kullanici"])){
		...
		?>
		<form action="index.php?SK=112" method="post">
						...
						<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
							...
							<tr height="30">
								<td colspan="2" valign="top"
								    style="border-bottom: 1px dashed #CCCCCC;">Adres ve Kargo Seçimini Aşağıdan Belirtebilirsin.
								</td>
							</tr>
							<tr height="10">
							...
							<tr height="40">
								...
								<td align="right" style="background: #CCCCCC; font-weight: bold;"><a href="index.php?SK=76"
								                                                                     style="color: #646464; text-decoration: none; font-weight: bold;">+ Yeni Adres Ekle&nbsp;</a>
								</td>
							</tr>
							<?php
								...
								if($SepettekiUrunSayisi > 0){
									...
									if($AdresSayisi > 0){
										foreach($AdresKayitlari as $AdresSatirlari){
											...
											<tr>
												<td colspan="2" align="left">
													<table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
														<tr height="50">
															<td width="25" style="border-bottom: 1px dashed #CCCCCC;" align="left"><input type="radio"
															                                                                              name="AdresSecimi"
															                                                                              checked="checked"
															                                                                              value="<?php echo DonusumleriGeriDondur($AdresSatirlari["id"]); ?>">
															</td>
															<td width="775" style="border-bottom: 1px dashed #CCCCCC;"
															    align="left"><?php echo DonusumleriGeriDondur($AdresSatirlari["AdiSoyadi"]); ?> - <?php echo DonusumleriGeriDondur($AdresSatirlari["Adres"]); ?> <?php echo DonusumleriGeriDondur($AdresSatirlari["Ilce"]); ?> / <?php echo DonusumleriGeriDondur($AdresSatirlari["Sehir"]); ?> - <?php echo DonusumleriGeriDondur($AdresSatirlari["TelefonNumarasi"]); ?></td>
														</tr>
													</table>
												</td>
											</tr>
										...
										<tr height="50">
											<td colspan="2"
											    align="left">Sisteme kayıtlı adresiniz bulunmamaktadır. Lütfen öncelikle "Hesabım" alanından "Adres" ekleyiniz. Adres eklemek için lütfen
												<a href="index.php?SK=76"
												   style="color: #646464; text-decoration: none; font-weight: bold;">buraya tıklayınız</a>.
											</td>
										</tr>
										<?php
									}
									...
									<tr height="40">
										<td colspan="2" align="left"
										    style="background: #CCCCCC; font-weight: bold;">&nbsp;Kargo Firması Seçimi
										</td>
									</tr>
									<tr height="10">
										<td colspan="2" style="font-size: 10px;">&nbsp;</td>
														...
														foreach($KargoKayitlari as $KargoKaydi){
															...
															<td width="260">
																<table width="260" align="center" border="0" cellpadding="0" cellspacing="0"
																	...
																	<tr height="40">
																		<td align="center"><img
																				src="Resimler/<?php echo DonusumleriGeriDondur($KargoKaydi["KargoFirmasiLogosu"]); ?>"
																				border="0"></td>
																	</tr>
																	<tr>
																		<td align="center"><input type="radio" name="KargoSecimi"
																		                          <?php if($SecimIcinSayi == 1){ ?>checked="checked" <?php } ?>
																		                          value="<?php echo DonusumleriGeriDondur($KargoKaydi["id"]); ?>">
																		</td>
																	</tr>
																	<tr>
																		<td>&nbsp;</td>
									...
									header("Location:index.php?SK=107");
									exit();
								}
							?>
						</table>
