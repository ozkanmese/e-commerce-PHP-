			...
			<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="500" valign="top">
						<form action="index.php?SK=82&UrunID=<?php echo $GelenUrunID; ?>" method="post">
							<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
								...
								<tr height="30">
									<td valign="top"
									    style="border-bottom: 1px dashed #CCCCCC;">Satın Almış olduğunuz Ürün İle Alakalı Aşağıdan Yorumunu Belirtebilirsin.
									</td>
								</tr>
								<tr height="30">
								...
								<tr height="30">
									<td valign="top" align="left" ><textarea style="width: 500px; height: 100px; padding:15px" name="Yorum" class="YorumIcinTextAreaAlanlari"></textarea>
									</td>
								</tr>
								<tr height="40">
									<td colspan="2" align="center"><input type="submit" value="Yorumu Gönder" class="TuruncuButon"></td>
								</tr>
							</table>
						</form>
					</td>
