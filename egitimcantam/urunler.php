<?php
	if(isset($_GET["ID"])){
		...
		if($UrunSayisi > 0){
			...
			}elseif($UrunTuru == "Üniversite Kitapları"){
					...
					<td width="705" valign="top">
						<table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr height="50" bgcolor="#F1F1F1">
								<td
									style="text-align: left; font-size: 18px; font-weight: bold;">&nbsp;<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["UrunAdi"]); ?></td>
							</tr>
							<tr>
								<td>
									<form action="index.php?SK=91&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>"
										...
										<table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
											<tr height="45">
												<td width="60"><?php if(isset($_SESSION["Kullanici"])){ ?><a
														href="index.php?SK=100&ID=<?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["id"]); ?>">
															<img src="Resimler/KalpKirmiziDaireliBeyaz24x24.png" border="0"
															     style="margin-top: 5px;"> Favorilere Ekle</a><?php }else{ ?><img
														src="Resimler/KalpKirmiziDaireliBeyaz24x24.png" border="0"
														style="margin-top: 5px;"><?php } ?></td>
												<td width="10">&nbsp;</td>
												<td width="400"><input type="submit" value="SEPETE EKLE" class="SepeteEkleButonu"></td>
											</tr>
											<tr height="45">
												<td colspan="5">
													<table width="705" align="center" border="0" cellpadding="0" cellspacing="0">
														<tr height="45">
															<td width="500" align="left"><select name="Varyant" class="SelectAlanlari">
																	<option
																		value="">Lütfen <?php echo DonusumleriGeriDondur($UrunSorgusuKaydi["VaryantBasligi"]); ?> Seçiniz
																	</option>
																	<?php
																		...
																		foreach($VaryantKayitlari as $VaryantSecimi){
																			?>
																			<option
																				value="<?php echo $VaryantSecimi["id"]; ?>"><?php echo DonusumleriGeriDondur($VaryantSecimi["VaryantAdi"]); ?></option>
																			<?php
																		}
																	?>
																</select></td>
															<td width="205" align="right"
															    style="font-size: 25px; color: black; font-weight: bold;"><?php echo FiyatBicimlendir($UrunFiyatiHesapla); ?> TL
															</td>
														</tr>
													</table>
												</td>
